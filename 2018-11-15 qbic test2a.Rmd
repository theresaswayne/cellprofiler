...
<!-- TODO: replace with the better data (test 3?) --> 
```{r reading DNA data, echo = FALSE}
qbic_C1DNANuclei <- read_csv("~/Google Drive/User projects/Demis qbic/test 2/qbic_C1DNANuclei.csv")
...
<!-- TODO: Insert images here of a general example -->
...
qbic_check <- read_csv("~/Documents/home-github/cellprofiler/2018-11-15 qbic test 2a.csv")
